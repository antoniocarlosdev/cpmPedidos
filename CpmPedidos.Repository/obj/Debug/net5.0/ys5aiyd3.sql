...
CREATE TABLE tb_cliente (
    ...
    id integer GENERATED BY DEFAULT AS IDENTITY,
    criado_em timestamp without time zone NOT NULL,
    CONSTRAINT "PK_tb_cliente" PRIMARY KEY ("IdEndereco"),
    CONSTRAINT "FK_cliente_endereco" FOREIGN KEY ("IdEndereco") REFERENCES tb_endereco (id) ON DELETE CASCADE
);
...
CREATE TABLE tb_pedido (
    ...
    CONSTRAINT "FK_tb_pedido_tb_cliente_id_cliente" FOREIGN KEY (id_cliente) REFERENCES tb_cliente ("IdEndereco") ON DELETE CASCADE
);
...
VALUES ('20210916163127_Init', '5.0.9');
